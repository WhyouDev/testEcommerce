    ...
    <body>
        <header>
            <div class="top-nav container">
                <div class="logo">testEcommerce</div>
                <ul>
                    <li><a href="#">Shop</a></li>
            ...
            <div class="hero container">
                <div class="hero-copy">
                    <h1>testEcommerce</h1>
                    <p>A practical example of using CSS Grid for testEcommerce</p>
        ...
        <div class="featured-section">
            <div class="container">
                <h1 class="text-center">testEcommerce</h1>
        ...
        <footer>
            <div class="footer-content container">
                <!-- <div class="made-with">Made with <i class="fa fa-heart"></i> by Unknown</div> -->
                <ul>
                    <li>Follow Me:</li>
